 ...
 function searchPostCode(){
	...
	$(function(){
		 ...
		 $('.input-daterange').datepicker({
		     ...
		     clearBtn: true,
		     forceParse: 0,
		     datesDisabled: ['2019-10-10','2019-10-11']
		 });
	})
			...
			<form:form id="applicationForm" class="needs-validation" commandName="applicationForm" role="form" action="${path}/equipment/insert.do">
				...
				<div class="form-row">
					<div class="input-group col-md-3 mb-3">
						...
						<div class="input-group-append">
							<button type="button" class="btn btn-secondary" onclick="searchPostCode()">주소검색</button>
						</div>
					</div>
				</div>
				<div class="form-row">
				...
				<div class="form-row">
					<div class="form-group col-md-10">
						<label for="startDate">이용 일자 </label>
						...
						<div class="card">
							...
							<div class="card-footer">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <input type="hidden" name="isAgreePrivacyinfo" value="0">
