      ...
      <div class="login-box">
          <div class="card">
              ...
              <p class="login-box-msg">장비 예약 확인</p>
                  <form:form commandName="applicationFormVO" id="loginForm" role="form" method="post" action="${path}/reservation/detail.do" class="needs-validation">
                      ...
                      <div class="form-group has-feedback">
                          <form:input type="password" class="form-control" path="passwd" placeholder="비밀번호" required="true"/>
                          <div class="invalid-feedback">
                              비밀번호를 입력하세요
                          </div>
                      </div>
