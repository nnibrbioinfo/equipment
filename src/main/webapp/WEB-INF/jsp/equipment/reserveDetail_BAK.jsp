	                            ...
	                            <div class="table-responsive">
	                                <table class="table">
	                                    <tbody>
	                                        ...
	                                        <tr>
	                                            <th>이용일자</th>
	                                            <td><c:out value="${reservInfo.startDate}"></c:out> ~ <c:out value="${reservInfo.endDate}"></c:out>. <c:out value="${reservInfo.hours}"></c:out>시간</td>
	                                            <th>전자우편</th>
	                                ...
	                                <table class="table">
	                                    <tbody>
											...
											<tr>
										    	...
										    	<c:if test="${empty reservInfo.isPermission}">
										    		<td><span>관리자가 확인중이오니 기달려주세요</span></td>
										    	</c:if>
										    	<c:if test="${reservInfo.isPermission eq true}">
